...
class LeadsOptinSuccessNotification implements NotificationTypeInterface
{
    ...
    public function getTokenDefinitions(): array
    {
        return [
            ...
            $this->tokenDefinitionFactory->create(AnythingTokenDefinition::class, 'optin_tstamp', 'optin.optin_tstamp'),
            $this->tokenDefinitionFactory->create(AnythingTokenDefinition::class, 'optin_ip', 'optin.optin_ip'),
